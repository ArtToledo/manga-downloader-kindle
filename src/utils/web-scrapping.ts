...
import { RespostaLinksImagensManga } from '../types/resposta-links-imagens-manga'

const pegaLinksDasImagensNoSite = async (linkManga): Promise<RespostaLinksImagensManga> => {
  ...
  let linkDasFotosDasPaginas: string[] = []
...
export { pegaLinksDasImagensNoSite }
